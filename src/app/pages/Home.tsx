...
const GOOGLE_REVIEW_URL = 'https://g.page/r/CRLf-SuPr3BbEBE/review';
...
export function Home() {
  ...
  return (
    <>
      ...
      <section ref={heroRef} className="relative h-[92svh] flex items-end justify-center overflow-hidden pb-16 md:pb-24">
        <div ref={imageRef} className="absolute inset-0 scale-110">
          <img
            ...
            className="w-full h-full object-cover [object-position:70%_center] md:object-center"
          />
      ...
      {/* GOOGLE AVIS */}
      <section className="flex justify-center py-6 bg-white">
        <a
        ...
        >
          <div
            ...
            style={{ background: `linear-gradient(135deg, rgba(58,180,177,0.10), rgba(58,180,177,0.03))` }}
          />
          ...
          <div className="relative z-10 flex flex-col items-start text-left leading-tight">
            <span className="text-gray-500 text-xs font-medium uppercase tracking-wide">Votre avis compte</span>
            <span className="text-black text-base font-extrabold">Noter Le Quai Restaurant Narbonne sur Google</span>
            <div className="flex items-center gap-2 mt-1">
              <div className="flex text-yellow-400 text-sm tracking-tight">★★★★★</div>
              <span className="text-gray-600 text-xs font-semibold">1300+ avis clients</span>
            </div>
          </div>
        </a>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-4xl mx-auto text-center">
            {[
              ...
              { value: "Ouvert", label: "du Lundi au Samedi de 09:00 à 14:00 et de 19:30 à 22:00 sauf le Mercredi Fermé et le dimanche de 10:00 à 14:00" },
