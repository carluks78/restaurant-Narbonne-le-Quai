...
const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    dishes: [
      ...
      { name: "Brioche perdue", description: "1 boule vanille, caramel, amandes grillées, chantilly", price: "8€" },
  ...
  },
  {
    ...
    dishes: [
      ...
      { name: "Le Rio", description: "Jus d'orange, ananas, sirop de grenadine", price: "7€" },
      ...
      { name: "Planteur", description: "Rhum, jus d'orange, jus d'ananas, sirop de grenadine, glace mangue", price: "9€" },
  ...
  },
  {
    ...
    dishes: [
      ...
      { name: "Carafe ½ litre", price: "8€", popular: true },
      { name: "Carafe 1 litre", price: "12€", popular: true },
    ],
  },
];
